...
<main class="sm:container sm:mx-auto sm:max-w-lg sm:mt-10">
    <div class="flex">
        <div class="w-full">
            ...
            @if (session('resent'))
            <div class="text-sm border border-t-8 text-green-700 border-green-600 bg-green-100  px-3 py-4 mb-4"
                role="alert">
                ...
                <div class="w-full flex flex-wrap text-gray-700 leading-normal text-sm p-6 space-y-4 sm:text-base sm:space-y-6">
                    ...
                    <p>
                        If you did not receive the email, <a
                            class="text-indigo-500 hover:text-indigo-700 no-underline hover:underline cursor-pointer"
                            onclick="event.preventDefault(); document.getElementById('resend-verification-form').submit();">click here to request another</a>.
                    </p>
