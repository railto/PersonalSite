...
<main>
    <header>
        <nav class="flex items-center justify-between px-4 lg:px-32 py-2 flex-wrap w-full z-10 top-0"
             ...
             :class="{ 'shadow-lg bg-indigo-600' : isOpen , 'bg-indigo-600' : !isOpen}"
        >
            <!--Logo etc-->
            ...
            >
                ...
                <ul class="pt-6 lg:pt-0 mb-0 list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3">
                        <a class="inline-block py-2 px-4 text-white no-underline" href="{{ route('index') }}"
                    ...
                    <li class="mr-3">
                        <a class="inline-block py-2 px-4 text-white no-underline" href="{{ route('uses') }}"
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center -mx-2">
                    <a class="flex items-center mx-2 text-gray-600 hover:text-indigo-600"
                       href="https://twitter.com/railto" target="_blank">
                    ...
                    <a class="flex items-center mx-2 text-gray-600 hover:text-indigo-600"
                       href="https://github.com/railto" target="_blank">
                        <svg class="h-5 w-5 fill-current" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
                            <path
